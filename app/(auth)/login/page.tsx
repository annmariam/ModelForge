...
export default function LoginPage() {
    ...
    const handleForgotPassword = async () => {
        try {
            const response = await userActions.forgetPassword(email);
            if (response.success) {
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <CardFooter className="flex flex-col space-y-2">
                        ...
                        <div className="flex justify-between">
                            <Button variant="link" className="text-sm" onClick={handleForgotPassword} disabled={!email}>Forgot password?</Button>
                            <Link href="/register">
