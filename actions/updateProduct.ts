...
export default async function updateProduct(id: string, name: string, price: number, image: string, description: string, category: string, material: string, size: string, link: string) {
    try {
